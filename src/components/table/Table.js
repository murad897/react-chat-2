      ...
      return (
         <TableBody>
            {products.map((product, index) => (
               <TableRow className="data-row" key={index} onDoubleClick={(e) => HandleDubbleClick(e, index)}>
                  <TableCell component="th" scope="row">
                     <Checkbox
                        ...
                        onClick={async (e) => {
                           ...
                           const getProducts = await axios.get(`http://localhost:3003/products`, headers);
                     ...
                     <Checkbox
                        ...
                        onClick={async (e) => {
                           ...
                           const checkPorducts = await axios.post(
                              `http://localhost:3003/products/search`,
                              {
                                 name: inputVal,
                              },
                              headers
